...
const rawWorks: WorkInput[] = [
  ...
  {
    name: '조서영',
    title: '제1회 조랭이픽처스 상영회 (The 1st Joreng Pictures Screening)',
    slug: 'choseoyoung',
    keyword: '99 Checklist Items',
    descriptionKo:
